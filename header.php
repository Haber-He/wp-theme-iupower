...
<html lang="zh-CN">
	<head>
		...
		<link type="text/css" media="screen" href="<?php bloginfo('template_url'); ?>/css/autoptimize_ac.css?13" rel="stylesheet" />
		...
		<meta name="generator" content="GLT <?php bloginfo('version'); ?>" />
	...
	<body class="custom-background" style="">
		...
		<header class="header">
			<div class="inner">
				...
				<div id="mobile-nav"> 
					<a id="mobile-menu"></a> 
					<a id="mobile-logo" href="<?php bloginfo('url');?>" rel="home">
						<img src="<?php bloginfo('template_url'); ?>/images/logo.png" alt="<?php bloginfo('name'); ?>" />
					</a>
					<a id="mobile-so"></a>
				</div> 
